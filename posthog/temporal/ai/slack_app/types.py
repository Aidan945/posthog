...
class PostHogCodeSlackMentionWorkflowInputs:
    ...
    # the sandbox JWT plus the MCP and GitHub rebinds follow the message's
    # actor instead of the task creator. The legacy per-message workflow
    # leaves this False and keeps creator-bound credentials throughout.
