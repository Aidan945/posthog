...
def _make_context(product: str, *, credits_exhausted: bool = False) -> ThrottleContext:
    return ThrottleContext(user=_make_user(), product=product, credits_exhausted=credits_exhausted)
